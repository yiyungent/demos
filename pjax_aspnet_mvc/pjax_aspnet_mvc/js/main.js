...
$(document).pjax('[data-pjax] a, a[data-pjax]', '#pjax-container', {
	type: 'GET', // 默认
	fragment: '#content' 
	// 指定只要 #content 元素内的内容, 将其放入 #pjax-container 元素内, 不过注意：这样做，其实没有实现局部请求，请求量为整个页面，只是只取了其中的 #content, 当然也可以让Net, Php等页面本身只具有局部html,但那样直接访问/Home/Net时就和 iframe一样只能看到局部
});
